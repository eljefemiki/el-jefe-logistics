...
export default function FuelStats({ stats }: { stats: { monthlySpend: number; monthlyQuantity: number; averageUnitPrice: number; transactions: number } }) {
  const cards = [
    ...
    { label: "Average price", value: `${money(stats.averageUnitPrice)}/L`, icon: Gauge },
