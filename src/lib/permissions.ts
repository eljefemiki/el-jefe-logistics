...
export const permissions = ["dashboard:view","fleet:view","fleet:manage","drivers:view","drivers:manage","dispatch:view","dispatch:manage","customers:view","customers:manage","workshop:view","workshop:manage","fuel:view","fuel:manage","finance:view","finance:manage","documents:view","documents:manage","notifications:view","audit:view","settings:view","settings:manage"] as const;
...
export const rolePermissions: Record<UserRole, readonly Permission[]> = {
  ...
  DISPATCHER: ["dashboard:view","fleet:view","drivers:view","dispatch:view","dispatch:manage","customers:view","documents:view","notifications:view"],
  ...
  FINANCE: ["dashboard:view","customers:view","finance:view","finance:manage","documents:view","documents:manage","notifications:view"],
  WORKSHOP: ["dashboard:view","fleet:view","workshop:view","workshop:manage","documents:view","documents:manage","notifications:view"],
  DRIVER: ["dashboard:view","fleet:view","dispatch:view","documents:view","notifications:view"], APPLICANT: [],
};
